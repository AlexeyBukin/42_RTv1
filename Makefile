...
src/utils/vector_3.c               src/utils/vector_5.c             src/utils/num_1.c               \
src/utils/ray.c                    src/window.c                     src/rt.c                        \
src/events.c                       src/scene/rt_material_to_str.c   src/scene/parse/comments.c      \
src/scene/parse/add_light.c        src/scene/parse/read_comma.c     src/scene/parse/add_material.c  \
src/scene/parse/scene_from_file.c  src/scene/parse/read_num.c       src/scene/parse/add_figure.c    \
src/scene/parse/read_id.c          src/scene/parse/read_vec.c       src/scene/rt_scene.c            \
src/scene/rt_figure_to_str.c       src/scene/rt_light_to_str.c      src/trace/trace_dot_cylinder.c  \
