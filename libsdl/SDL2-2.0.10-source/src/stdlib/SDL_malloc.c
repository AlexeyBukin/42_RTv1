...
malloc_getpagesize         default: derive from system include, or 4096.
...
/*
  ...
  /usr/include/malloc.h file that include a declaration of struct
...
/*
  ...
  because of alignment and bookkeeping overhead. Because it include
...
/*
  (The following include lightly edited explanations by Colin Plumb.)
...
/*
  ...
  Top
    ...
    topsize+TOP_FOOT_SIZE, which include space reserved for adding
...
/*
  ...
  * MORECORE need not handle negative arguments -- it may instead
  ...
  this section, adding some #include, and setting up the appropriate
  defines above:
